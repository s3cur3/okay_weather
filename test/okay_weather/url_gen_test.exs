defmodule OkayWeather.UrlGenTest do
  ...
  import OkayWeather.UrlGen, only: [gfs: 1, wafs: 1, metar: 1]
  ...
  test "generates GFS URLs" do
    ...
    assert gfs(@early) ==
             "#{gfs_base}?dir=%2Fgfs.20190212/18&file=gfs.t18z.pgrb2.1p00.f006&lev_700_mb=1&lev_250_mb=1&var_UGRD=1&var_VGRD=1"

    assert gfs(@mid) ==
             "#{gfs_base}?dir=%2Fgfs.20190212/12&file=gfs.t12z.pgrb2.1p00.f003&lev_700_mb=1&lev_250_mb=1&var_UGRD=1&var_VGRD=1"

    assert gfs(@late) ==
             "#{gfs_base}?dir=%2Fgfs.20190211/18&file=gfs.t18z.pgrb2.1p00.f003&lev_700_mb=1&lev_250_mb=1&var_UGRD=1&var_VGRD=1"
  end
